...
async def random_video_callback(client, query):
    ...
    keywords = {
        ...
        "parent": ["မိဘ", "အမေ", "အဖေ"],
        "child": ["child"],
        "male": ["​စိုင်းထီးဆိုင်", "​လေးဖြူ", "​မျိုးကြီး"​, "​ဝိုင်ဝိုင်း", "​​စိုးလွင်လွင်", "​​စိုင်းစိုင်းခမ်းလှိုင်", "​အာဇာနည်", "​​ဂရေဟမ်", "​​ဖြိုးကြီး"​, "​ဘန်နီဖြိုး", "​​ရွှေထူး", "​​ရဲရင့်အောင်"],
        "female": ["​ဝိုင်စုခိုင်သိန်း", "​​နီနီခင်ဇော်", "​​ဖြူဖြူကျော်သိန်း"​, "​​ချန်းချန်း", "​​​အိမ့်ချစ်", "​​​ပိုပို", "​​အယ်လ်ဆိုင်းဇီ", "​​​နန်းသူဇာ", "​​​မေခလာ"​, "​​တင်ဇာမော်", "​​​ဆုန်သင်းပါရ်", "​​ပန်းရောင်ခြယ်"],
